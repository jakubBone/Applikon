<p align="center">
  <img src="logo.svg" alt="EasyApply" width="80" height="80">
</p>
...
**Kanban board** - visual overview of recruitment status: Sent → In progress → Completed. Drag & drop support.
...
MVP version. Data stored locally in browser.
