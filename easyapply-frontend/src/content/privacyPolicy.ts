...
Administratorem Twoich danych osobowych w aplikacji **EasyApply** jest Jakub Boniecki, twórca projektu, dostępny pod adresem **${CONTACT_EMAIL}**.

EasyApply jest darmowym projektem portfolio prezentującym moje umiejętności programistyczne. Nie prowadzę działalności zarobkowej w oparciu o tę aplikację ani nie sprzedaję danych.
...
The data controller for your personal data in the **EasyApply** application is Jakub Boniecki, the project creator, reachable at **${CONTACT_EMAIL}**.

EasyApply is a free portfolio project showcasing my programming skills. I do not run a commercial business based on this application, nor do I sell any data.
